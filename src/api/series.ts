...
export const updateSeries = (hashId: string, values: object) => axios.put(`/series/${hashId}`, values);
...
export const addPost = (postId: string, series: string) =>
    axios.put(`/series/${series}/addPost`, { post_id: postId });

export const removePost = (postId: string, series: string) =>
    axios.put(`/series/${series}/removePost`, { post_id: postId });

export const movePostBefore = (nextPostId: string, postId: string, series: string) =>
    axios.put(`/series/${series}/movePostBefore`, {
